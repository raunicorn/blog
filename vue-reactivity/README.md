# 先大概说下Vue响应式实现的原理。
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image.jpg)
...
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image.png)
...
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(2).png)

可以看到，创建Vue实例时，会调用`this._init`方法，接下来看一下`this._init`方法中的关键代码。

![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(3).png)

这里面调用了一个initState方法，看一下initState方法干了什么。

![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(4).png)
...
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(5).png)

首先，组件options中的data会被赋给`vm._data`，然后会执行`observe（data，true）`，接下来看看observe方法是怎么定义的。

## Observer

![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(6).png)
...
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(7).png)
...
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(8).png)
...
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(9).png)

![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(10).png)

![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(11).png)
...
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(12).png)

## Render

接下来看一下Vue组件的渲染过程。

![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(13).png)
...
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(14).png)

在$mount方法中，会调用compileToFunctions方法生成render和staticRenderFns。render就是render函数，staticRenderFns是一个数组，包含着不会发生变化的VNode节点所生成的函数。

![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(15).png)

接下来，$mount方法会调用这个mount方法，而这个mount方法会调用mountComponent方法。

![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(16).png)

可以看到在mountComponent方法中，会创建一个新的Watcher对象，并传入updateComponent函数，这个函数会返回`vm._update(vm._render(), hydrating)`。

![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(17).png)
...
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(18).png)

首先它会将getter设为expOrFn，从上面看到，在渲染时，这个expOrFn就是updateComponent函数。然后会调用get方法。

![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(19).png)
...
![image](https://github.com/raunicorn/blog/blob/master/vue-reactivity/assets/Image%20(20).png)
